...
export function ProjectDialog({ open, onOpenChange, project, onSuccess }: ProjectDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-6xl h-[90vh] flex flex-col p-0 overflow-hidden bg-background border border-border/80 shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] rounded-[2rem]">
